...
| Field       | Value                    |
| ----------- | ------------------------ |
| Registry      | `oci://registry-1.docker.io/stephenjr002/sairo` |
...
```bash
helm install sairo oci://registry-1.docker.io/stephenjr002/sairo \
  --namespace sairo \
  --create-namespace \
...
```bash
helm upgrade sairo oci://registry-1.docker.io/stephenjr002/sairo \
  --namespace sairo \
  -f values-production.yaml
```
...
```bash
helm template sairo oci://registry-1.docker.io/stephenjr002/sairo \

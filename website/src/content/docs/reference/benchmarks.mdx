...
| **Production S3** | Leaseweb Object Storage (us.object-storage.io) |
...
| `adrequest` | 200 | **2.4ms** | 16.2ms |
| `pixel` | 200 | **2.3ms** | 3.0ms |
| `flatevents` | 200 | **2.5ms** | 3.4ms |
| `sampling` | 200 | **2.4ms** | 5.5ms |
...
| ssp-production-reports | 134,707 | completed | Production-scale crawl |
